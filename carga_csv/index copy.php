...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_FILES['file'])) {
        ...
        if (($handle = fopen($file, 'r')) !== FALSE) {
            ...
            header('Location: index.php?step=map');
            exit();
        } else {
        ...
        echo '<a href="index.php" style="text-decoration: none;">Regresar al inicio</a>';
        session_destroy();
        exit();
    }
} else {
...
?>
        ...
        <head>
            ...
            <title>Mapeo de Cabeceras del CSV a la Tabla <?= $tabla ?></title>
            <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet">
        </head>

        <body>
            <div class="container">
                <h1 class="mt-5">Mapeo de Cabeceras del CSV a la Tabla <?= $tabla ?></h1>
                <form action="index.php" method="post">
                    <table class="table table-bordered mt-3">
                        <thead>
                            <tr>
                                <th>Cabeceras de la Tabla <?= $tabla ?></th>
